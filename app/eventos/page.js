...
import FormEventos from "@/componentes/Eventos/formEventos";
import { gravarRegistro as gravarEvento } from "../../Modulos/eventoActions/gravarRegistro.js";
    ...
    <div className="h-screen bg-gray-100">
      <div className="grid h-full grid-cols-[240px_1fr] grid-rows-[80px_1fr_60px] gap-4 p-4">
        ...
        <main className="bg-gray-100 rounded-2xl shadow-md p-6 min-h-screen">
          <FormEventos action={gravarEvento} />
        </main>
