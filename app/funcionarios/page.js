          ...
          <nav aria-label="Menu administrativo">
            <ul className="space-y-2">
              <li>
                <Link
                  href="/adm"
                  className="block font-bold rounded-2xl px-4 py-3 text-gray-700 hover:bg-green-900 hover:text-green-100"
                >
                  Dashboard
                </Link>
              </li>
              <li>
                <Link
                  href="/funcionarios"
                  className="block font-bold rounded-2xl px-4 py-3 text-gray-700 hover:bg-white hover:text-green-900"
                >
                  Funcionários
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className="block font-bold rounded-2xl px-4 py-3 text-gray-700 hover:bg-green-100 hover:text-green-600"
                >
                  Pontos Turísticos
                </Link>
              </li>
