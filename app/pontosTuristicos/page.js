...
import FormTurista from "@/componentes/pontosTuristicos/formTurista";
import { gravarRegistro as gravarPonto } from "../../Modulos/pontosTuristicosActions/gravarRegistro.js";
  ...
  return (
    <div className="h-screen bg-gray-100">
      <div className="grid h-full grid-cols-[240px_1fr] grid-rows-[80px_1fr_60px] gap-4 p-4">
        ...
        <aside className="row-span-2 bg-gray-300 rounded-2xl h-shadow-md p-6">
          <h2 className="text-lg font-bold text-green-900 mb-4">Menu</h2>
        ...
        <main className="bg-gray-100 rounded-2xl shadow-md p-6">
          <FormTurista action={gravarPonto} />
        </main>
