...
import FormHospede from "@/componentes/Hospedagem/formHospede";
import { gravarRegistro as gravarHospedagem } from "../../Modulos/hospedagemActions/gravarRegistro.js";
    ...
    <div className="h-screen bg-gray-100">
      <div className="grid h-full grid-cols-[240px_1fr] grid-rows-[80px_1fr_60px] gap-4 p-4">
        ...
        <main className="bg-gray-100 rounded-2xl shadow-md p-6">
          <FormHospede action={gravarHospedagem} />
        </main>
